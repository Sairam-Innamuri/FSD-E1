...
<body>
    ...
    <div class="container-wide" style="padding-top: 40px;">
        <div class="card">
            ...
            <p class="card-subtitle">Choose a quiz category • 10 questions • 20 seconds per question</p>

            <div style="background: white; border: 2px solid var(--border); border-radius: var(--radius); padding: 20px; margin-bottom: 24px;">
